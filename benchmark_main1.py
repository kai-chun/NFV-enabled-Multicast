...
def main(topology, bandwidth, exp_num, group, gen_new_data):
    ...
    while exp_factor <= bound_factor: 
        ...
        for i in range(exp_num):
            ...
            G_main_noG = copy.deepcopy(input_graph[0]) 
            ...
            failed_num_main_noG = 0
            failed_num_merge_noG = 0
            failed_num_main = 0
            failed_num_merge = 0
            ...
            transcoder_num_main_noG = 0
            transcoder_num_merge_noG = 0
            ...
            running_time_main_noG = 0
            running_time_merge_noG = 0
            running_time_main = 0
            ...
            for j in group_list_noG:
                ...
                service_main_noG = copy.deepcopy(service_unicast)
            ...
            # cost_tuple_main_noG = Graph.cal_total_cost(G_main_noG, weight, True)
            # cost_tuple_merge_noG = Graph.cal_total_cost(G_merge_noG_ans[0], weight, True)
            ...
            cost_tuple_merge = Graph.cal_total_cost_normalize(input_graph[0],G_merge_ans[0], weight, True)
            ...
            if total_dst == failed_num_main_noG:
                ...
                dst_num_main_noG = total_dst - failed_num_main_noG
                exp_data_main_noG[4].append(cost_tuple_main_noG[0]/dst_num_main_noG)
            if total_dst == failed_num_merge_noG:
                exp_data_merge_noG[4].append(0)
            else:
                dst_num_merge_noG = total_dst - failed_num_merge_noG
                exp_data_merge_noG[4].append(cost_tuple_merge_noG[0]/dst_num_merge_noG)
